            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed text-lg">
                  في شركة Vitaxir، نحن نقدر خصوصيتك ونلتزم بحماية معلوماتك
                  الشخصية. توضح سياسة الخصوصية هذه كيفية جمعنا واستخدامنا وحماية
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  ...
                  <ul className="list-disc list-inside space-y-2 mr-6">
                    ...
                    <li>رقم الهاتف</li>
                    <li>
                      المعلومات الطبية ذات الصلة (عند الضرورة لتقديم الخدمة)
                    </li>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  نتخذ جميع التدابير الأمنية المناسبة لحماية معلوماتك الشخصية من
                  الوصول غير المصرح به أو التعديل أو الإفصاح أو التدمير. نستخدم
                  تقنيات التشفير والبروتوكولات الآمنة لحماية بياناتك أثناء النقل
                  والتخزين.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  لا نقوم ببيع أو تأجير أو مشاركة معلوماتك الشخصية مع أطراف
                  ثالثة إلا في الحالات التالية:
                </p>
